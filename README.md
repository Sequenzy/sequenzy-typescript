...
```sh
npm install git+ssh://git@github.com:stainless-sdks/sequenzy-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install sequenzy`
...
1. Via the `SEQUENZY_LOG` environment variable
...
const client = new Sequenzy({
  logger: logger.child({ name: 'Sequenzy' }),
...
const client = new Sequenzy({ fetch });
```
...
```ts
import Sequenzy from 'npm:sequenzy';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/sequenzy-typescript/issues) with questions, bugs, or suggestions.
