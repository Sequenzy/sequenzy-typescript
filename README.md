...
```sh
npm install git+ssh://git@github.com:Sequenzy/sequenzy-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/Sequenzy/sequenzy-typescript/issues) with questions, bugs, or suggestions.
